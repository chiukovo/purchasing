...
<div class="page-body">
	<div class="card material-table">
		...
		<ul class="page-tabs">
			<li class="tab <?php if ($type == '') { echo 'active';}?>"><a href="<?php echo base_url()?>warehouse/dataList?type=&start=<?php echo $start;?>&end=<?php echo $end;?>">全部</a></li>
			<?php foreach ($warehouse as $name) { ?>
			<li class="tab <?php if ($type == $name) { echo 'active';}?>">
				<a href="<?php echo base_url()?>warehouse/dataList?type=<?php echo $name;?>&start=<?php echo $start;?>&end=<?php echo $end;?>"><?php echo $name;?></a>
			</li>
			<?php } ?>
            <li>
